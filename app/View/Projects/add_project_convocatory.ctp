	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Subir Proyecto'); ?></h1>
			</div>
		</div>
	</div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
                            <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;Listar convocatorias'), array('controller'=>'convocatories', 'action' => 'indexCurrentConvocatories'), array('escape' => false)); ?> </li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;Listar Proyectos'), array('action' => 'indexResearchProjects', $this->Session->read('User.id')), array('escape' => false)); ?></li>
						</ul>
					</div>
				</div>
			</div>
