				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-arrow-up"></span>&nbsp&nbsp;Subir proyecto'), array('controller'=>'projects', 'action' => 'addProjectConvocatory', $convocatory['Convocatory']['id']), array('escape' => false)); ?> </li>
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;Listar convocatorias'), array('action' => 'indexCurrentConvocatories'), array('escape' => false)); ?> </li>
						</ul>
					</div><!-- end body -->
				</div><!-- end panel -->
			</div><!-- end actions -->
