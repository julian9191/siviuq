				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Crear convocatoria'), array('action' => 'add'), array('escape' => false)); ?></li>
						</ul>
					</div><!-- end body -->
				</div><!-- end panel -->
			</div><!-- end actions -->
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $convocatory['Convocatory']['id']), array('escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $convocatory['Convocatory']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $convocatory['Convocatory']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $convocatory['Convocatory']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</tbody>
