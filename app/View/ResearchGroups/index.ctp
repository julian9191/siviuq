<div class="researchGroups index">

	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Grupos de investigación'); ?></h1>
			</div>
            ...
            <div class="col-md-12 text-right">
                ...
                <?php
                    echo $this->Form->create('ResearchGroup', array('url' => array_merge(array('action' => 'index'), $this->params['pass'])));
                 ?> 
                <div class="col-md-4">
                    <?php  
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo h($researchGroup['ResearchGroup']['colciencias_code']); ?>&nbsp;</td>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $researchGroup['ResearchGroup']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $researchGroup['ResearchGroup']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</tbody>
