	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Editar tipo de usuario'); ?></h1>
			</div>
		</div>
	</div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							...
							<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Eliminar'), array('action' => 'delete', $this->Form->value('UserType.id')), array('escape' => false), __('Are you sure you want to delete # %s?', $this->Form->value('UserType.id'))); ?></li>
