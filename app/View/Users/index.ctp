	...
	<div class="row">
		<div class="col-md-12">
            ...
            <div class="col-md-12 text-right">
                ...
                <?php
                    echo $this->Form->create('User', array('url' => array_merge(array('action' => 'index'), $this->params['pass'])));
                 ?> 
                <div class="col-md-4">
                    <?php  
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<ul class="nav nav-pills nav-stacked">
							<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Crear usuario'), array('action' => 'add'), array('escape' => false)); ?></li>
						</ul>
					</div><!-- end body -->
				</div><!-- end panel -->
			</div><!-- end actions -->
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo h($user['Departament']['name']); ?>&nbsp;</td>
