<div class="researchGroupsResearches form">
	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<div class="form-group">
				<?php echo $this->Form->input('researche_id', array('class' => 'form-control', 'placeholder' => 'Investigador','label' => 'Nombre'));?>
			</div>
			<div class="form-group">
				<?php echo $this->Form->input('research_group_id', array('class' => 'form-control', 'placeholder' => 'Grupo de investigación','label' => 'Grupo de investigación'));?>
			</div>
			<div class="form-group">
