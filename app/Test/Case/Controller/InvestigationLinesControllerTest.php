<?php
App::uses('InvestigationLinesController', 'Controller');

/**
 * InvestigationLinesController Test Case
 *
 */
class InvestigationLinesControllerTest extends ControllerTestCase {
