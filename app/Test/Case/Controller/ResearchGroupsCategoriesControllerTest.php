<?php
App::uses('ResearchGroupsCategoriesController', 'Controller');

/**
 * ResearchGroupsCategoriesController Test Case
 *
 */
class ResearchGroupsCategoriesControllerTest extends ControllerTestCase {
