<?php
App::uses('NotificationsTemplatesController', 'Controller');

/**
 * NotificationsTemplatesController Test Case
 *
 */
class NotificationsTemplatesControllerTest extends ControllerTestCase {
