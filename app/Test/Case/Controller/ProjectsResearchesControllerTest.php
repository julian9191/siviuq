<?php
App::uses('ProjectsResearchesController', 'Controller');

/**
 * ProjectsResearchesController Test Case
 *
 */
class ProjectsResearchesControllerTest extends ControllerTestCase {
