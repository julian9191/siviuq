<?php
App::uses('ResearchGroupsTypesController', 'Controller');

/**
 * ResearchGroupsTypesController Test Case
 *
 */
class ResearchGroupsTypesControllerTest extends ControllerTestCase {
