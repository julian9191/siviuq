<?php
App::uses('ProductAttachmentsController', 'Controller');

/**
 * ProductAttachmentsController Test Case
 *
 */
class ProductAttachmentsControllerTest extends ControllerTestCase {
