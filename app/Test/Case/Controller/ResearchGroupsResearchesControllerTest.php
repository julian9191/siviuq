<?php
App::uses('ResearchGroupsResearchesController', 'Controller');

/**
 * ResearchGroupsResearchesController Test Case
 *
 */
class ResearchGroupsResearchesControllerTest extends ControllerTestCase {
